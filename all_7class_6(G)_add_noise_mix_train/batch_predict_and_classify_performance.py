...
# 測試圖片的根目錄列表（可以有多個根目錄）
INPUT_ROOT_DIRS = [
    r'/home/cckuo/m11307u09/GG/1126/data_GG_discharge/risk_discharge',
    r'/home/cckuo/m11307u09/GG/1126/data_GG_discharge/inbetween_discharge'
]

# 輸出根目錄的基礎路徑
OUTPUT_BASE_DIR = r'/home/cckuo/m11307u09/GG/1126/epsanet50/all in one/all_7class_6(G)_add_noise_mix_train/GG_gradcam'
...
def generate_performance_report(output_dir, timing_stats, class_counts,
    ...
    with open(report_path, 'w', encoding='utf-8') as f:
        ...
        f.write(f"CAM 方法: {CAM_METHOD.upper()}\n\n")
    ...
    for root_idx, INPUT_ROOT_DIR in enumerate(INPUT_ROOT_DIRS, 1):
        ...
        for subfolder_idx, subfolder_name in enumerate(subfolders, 1):
            ...
            if CAM_METHOD == 'gradcam':
                ...
                preprocessed_images = np.concatenate(batches, axis=0)
                preprocess_elapsed = time.time() - preprocess_start
                print(f"  [預處理] 完成: {preprocess_elapsed:.2f} 秒")
                timing_stats['preprocess_time'] += preprocess_elapsed
